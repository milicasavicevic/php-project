...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_position)){
        $salary_err = "Please enter your position.";     
    } else{
    ...
    if(empty($name_err) && empty($surname_err) && empty($position_err)){
        ...
        $sql = "UPDATE users SET name=?, surname=?, position=? WHERE id=?";
         
        if($stmt = mysqli_prepare($con, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_surname, $param_position, $param_id);
